...
// Type definitions for custom shader uniforms and config
...
// Helper to extend materials (shader injection)
function extendMaterial(
  BaseMaterial: new (options?: any) => THREE.Material,
  cfg: ExtendedMaterialConfig,
) {
  ...
  // Instantiate defaults to copy properties if needed
  ...
  (
    {
      ...
      count,
      height,
    }: { material: any; width: number; count: number; height: number },
    ref,
  ) => {
